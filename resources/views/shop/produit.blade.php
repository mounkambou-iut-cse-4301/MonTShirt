    ...
    <div class="album py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="produits/krusty_simpson.jpg" class="card-img-top img-fluid" alt="Responsive image">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="produits/star_trek.jpg" class="card-img-top img-fluid" alt="Responsive image">
